...
- **The memory (ai-memory-vault).** A folder of plain text files on their computer. Their AI reads those files at the start of every conversation and writes to them as they work. That is the entire trick. What that buys them: right now, every new chat starts with an AI that does not know their business, their customers, or what they decided yesterday, so they explain it all again. With the folder, they say "write the follow-up to that customer" and it already knows who the customer is, what the deal was, and how they write.
